...
export default function Profile() {
  return (
    <div className="bg-white/60 backdrop-blur-lg rounded-2xl shadow-xl p-8 max-w-lg mx-auto">
      <div className="flex items-center gap-4 mb-6">
        <UserCircleIcon className="h-16 w-16 text-primary-400" />
        <div>
          <div className="text-xl font-bold text-primary">Your Name</div>
          <div className="text-gray-500">your@email.com</div>
        </div>
      </div>
      <div className="text-gray-700">Profile settings and preferences go here.</div>
    </div>
  )
}